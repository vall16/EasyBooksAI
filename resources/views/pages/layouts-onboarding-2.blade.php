...
<main
      ...
      >
        ...
        >
          <div
            class="rounded-lg bg-linear-to-br from-amber-400 to-orange-600 py-6 px-5 text-center"
          >
          ...
          <div
            class="rounded-lg bg-linear-to-br from-pink-500 to-rose-500 py-6 px-5 text-center"
          >
          ...
          <div
            class="rounded-lg bg-linear-to-br from-purple-500 to-indigo-600 py-6 px-5 text-center"
          >
