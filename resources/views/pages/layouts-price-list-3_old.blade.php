...
<x-app-layout title="Price List 3" is-header-blur="true">
    <main class="main-content w-full place-items-center px-[var(--margin-x)] pb-12">
        ...
        <div class="grid max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
            <div class="rounded-xl bg-linear-to-br from-pink-500 to-rose-500 p-1">
            ...
            <div class="rounded-xl bg-linear-to-br from-purple-500 to-indigo-600 p-1">
                <div class="relative rounded-xl bg-slate-50 p-4 text-center dark:bg-navy-900 sm:p-5">
                    ...
                    <div class="mt-8">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="inline size-16 text-primary dark:text-accent-light" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
            ...
            <div class="rounded-xl bg-linear-to-br from-amber-400 to-orange-600 p-1">
                <div class="rounded-xl bg-slate-50 p-4 text-center dark:bg-navy-900 sm:p-5">
                    <div class="mt-8">
                        <svg xmlns="http://www.w3.org/2000/svg" class="inline size-16 text-warning" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                    ...
                    <div class="mt-5">
                        <span class="text-4xl tracking-tight text-warning">$25</span>/month
                    </div>
                    <div class="mt-8 space-y-4 text-left">
                        <div class="flex items-start space-x-3">
                            <div class="flex size-6 shrink-0 items-center justify-center rounded-full">
