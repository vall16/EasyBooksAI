<x-app-layout title="Banking Dashboard v2" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div
                class="col-span-12 grid grid-cols-12 rounded-lg bg-linear-to-r from-blue-500 to-indigo-600 py-5 sm:py-6">
                        ...
                        <div class="-mt-1 flex items-center space-x-2">
                            ...
                            <div x-data="usePopper({ placement: 'bottom-end', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                                ...
                                <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                    class="btn size-8 rounded-full p-0 hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between">
                                        <img class="h-3" src="{{ asset('images/payments/cc-visa-white.svg') }}"
                                            alt="image" />
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-indigo-100"
